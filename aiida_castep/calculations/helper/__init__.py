...
class CastepHelper(object):
    ...
    def get_help_info_paths(self):
        ...
        import os
        home = os.getenv("HOME")
        default_file_path = os.path.join(module_path, "castep_helpinfo.json")
    ...
    def load_helper_dict(self):
        ...
        if path is None:
            ...
            try:
                path = paths[0]  # No explicitly requested versio - use any
            except IndexError:
                ...
                version = help_dict["_CASTEP_VERSION"]
                # print("Using CASTEP help info for version {}".format(version))
        else:
            help_dict = load_json(path)
    ...
    def _check_dict(self, input_dict):
        ...
        :param dict input_dict: A dictonary with "PARAM" and "CELL"
 keys.        
