...
INPUT_LINKNAMES = {
    ...
    "parameters": "parameters",  # Input parameters e.g defines .cell and .param
    "kpoints": "kpoints",  # Input kpoints
    "pseudo": "pseudo",  # Input pseudopotential, namespace
    "settings": "settings",  # Extra settings for CASTEP
    "parent_calc_folder": "parent_calc_folder",  # Remote folder point to the parent calculation
    "prod_structure": "product_structure",  # Product structure in transition state search
}

OUTPUT_LINKNAMES = {
    "structure": "output_structure",  # The output structure
    "results": "output_parameters",  # Basic infomration, energies, units, etc
    "trajectory": "output_trajectory",  # Trajectory of md or geometry optimisation
...
EXIT_CODES_SPEC = OrderedDict(
    (
        (
            ...
            (101, "SCF Cycles failed to reach convergence", False),
        ),
        (
        ...
        (
            ...
            (105, "Cannot find the end of calculation", True),
        ),  # Indicated by the lack of summary line
        ...
        ("CALC_FINISHED", (0, "Calculation terminated gracefully, end found", False)),
    )
)
