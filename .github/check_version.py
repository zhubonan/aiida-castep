...
import aiida_castep  # pylint: disable=wrong-import-position

version = aiida_castep.__version__

if version != setup_content["version"]:
    print("Version number mismatch detected:")
    print("Version number in '{}': {}".format(setup_fname, setup_content["version"]))
    print("Version number in '{}/__init__.py': {}".format("aiida_castep", version))
    sys.exit(1)
